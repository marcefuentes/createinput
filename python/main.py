...
def main():
    ...
    generator = get_module_attribute(f"projects.{args.project}.generator", "generator")
    settings = get_module_attribute(f"projects.{args.project}.settings", "settings")
    layout = get_module_attribute(f"layouts.{args.layout}", "layout")
